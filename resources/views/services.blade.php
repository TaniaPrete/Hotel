...
<section id="services" class="py-5">
    ...
    <div class="container">
        <!-- Sezione Camere -->
        <div class="service-item" style="margin-bottom: 20px; border: 1px solid #ddd; padding: 15px; border-radius: 8px;">
            <h3>Camere eleganti</h3>
            <p>Comfort e lusso nelle nostre stanze uniche.</p>
            <a href="{{ route('rooms') }}" class="cta-button" style="background-color: #013A3A; color: white; padding: 10px 15px; border-radius: 5px; text-decoration: none;">Scopri le Camere</a>
        </div>
        ...
        <div class="service-item" style="margin-bottom: 20px; border: 1px solid #ddd; padding: 15px; border-radius: 8px;">
            ...
            <a href="{{ route('dining') }}" class="cta-button" style="background-color: #013A3A; color: white; padding: 10px 15px; border-radius: 5px; text-decoration: none;">Scopri la Ristorazione</a>
        </div>
        ...
        <div class="service-item" style="margin-bottom: 20px; border: 1px solid #ddd; padding: 15px; border-radius: 8px;">
            ...
            <a href="{{ route('spa') }}" class="cta-button" style="background-color: #013A3A; color: white; padding: 10px 15px; border-radius: 5px; text-decoration: none;">Scopri la SPA</a>
        </div>
    </div>
</section>
